...
export const courses = [
  {
    ...
    title:
      "Subscription based services have become increasingly popular in the recent years from mobile delivery services to monthly beauty boxes. Consider what type of product or service you could offer on a regular basis",
  },
  {
    id: 2,
    image: courses2,
    ...
    title:
      "As more events move online there is an opportunity to create virtual experinces for people. Consider hosting virtual conferences,workshops or concerts",
  },
  {
    id: 3,
    image: courses3,
  ...
  },
  {
    ...
    title:
      "Consumers are becoming more conscious of their environmental impact, and are looking for eco-friendly products and services.Consider starting a business that focuses on sustainability, such as a zero-waste store or a green cleaning service.",
  },
  {
    id: 5,
    image: courses5,
...
export const accordions = [
  ...
  {
    id: 2,
    title: "Are there any membership fees or charges for joining?",
  },
  {
    id: 3,
    title: "How can I showcase my business in the Business Spotlights section?",
  },
  {
    id: 4,
    title:
  ...
  {
    id: 7,
    title: "How can I participate in the Q&A Section?",
  },
